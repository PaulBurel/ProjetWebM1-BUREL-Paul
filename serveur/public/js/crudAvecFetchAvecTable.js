...
function afficheRestaurantsEnTable(restaurants) {
  ...
  for (var i = 0; i < restaurants.length; i++) {
    ...
    celluleRemove.innerHTML =
      "<button id=" +
      restaurant._id +
      ' onclick="supprimerRestaurant(event);">Supprimer</button>';

    let celluleModifier = ligne.insertCell();
    celluleModifier.innerHTML =
      "<button id=" +
      restaurant._id +
...
function modifierRestaurant(noLigne) {
  ...
  let cuisine = document.querySelector(
    "#restaurant" + noLigne + "Cuisine"
  ).textContent;

  console.log(
    "modifier Restaurant id=" + id + "avec nom=" + nom + " cusine= " + cuisine
  );
...
var donneeServeur = {
  ...
  data: [
    ...
    },
    {
      ...
      grades: [
        { date: "2014-09-17T00:00:00.000Z", grade: "A", score: 10 },
        { date: "2014-01-16T00:00:00.000Z", grade: "B", score: 23 },
        { date: "2013-08-07T00:00:00.000Z", grade: "A", score: 10 },
        { date: "2013-02-21T00:00:00.000Z", grade: "B", score: 27 },
        { date: "2012-06-20T00:00:00.000Z", grade: "B", score: 27 },
